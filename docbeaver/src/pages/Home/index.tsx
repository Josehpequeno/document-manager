...
export default function Home() {
  ...
  return (
    <div className="flex">
      <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-screen w-full max-w-[2.5rem] md:max-w-[12rem] p-1 md:p-4 shadow-xl shadow-blue-gray-900/5">
      ...
      <div className="h-full md:h-screen bg-slate-950 text-white flex-1">
        ...
        <div className="h-100 w-full p-0 md:p-4">
          {files.length === 0 ? (
            ...
            // items
            <div className="mt-4 px-3 items-center grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-2">
              {/* item */}
              {files.map((file) => (
                <div
                  id={file.toString()}
